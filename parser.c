...
// handles .8086, .80386
{
    ...
    if( temp & P_EXT_MASK ) {
        CodeInfo->info.cpu &= ~P_EXT_MASK;
        CodeInfo->info.cpu |= temp & P_EXT_MASK;
    }
...
// in: Opnd_Count=no of operand (0=1,1=2)
// out: CodeInfo
