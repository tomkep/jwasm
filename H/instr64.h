...
#if AMD64_SUPPORT
ins (CALL, call, 4,             OpCls( I32,     NONE,     NONE ), 0,       0,  no_RM,  0xE8,     0x00,       P_64,        0)
...
ins (LGDT, lgdt, 4,             OpCls( M80,     NONE,     NONE ), F_0F,    0,  no_WDS, 0x01,     0x10,       P_64,        0)
ins (LIDT, lidt, 4,             OpCls( M80,     NONE,     NONE ), F_0F,    0,  no_WDS, 0x01,     0x18,       P_64,        0)
#if 1
ins (SLDT, sldt, 4,             OpCls( RGT8,    NONE,     NONE ), F_0F,    0,  no_WDS, 0x00,     0x00,       P_64,        0)
insn(SLDT, 1,                   OpCls( M16,     NONE,     NONE ), F_0FNO66,0,  no_WDS, 0x00,     0x00,       P_286,       0)
ins (SMSW, smsw, 4,             OpCls( RGT8,    NONE,     NONE ), F_0F,    0,  no_WDS, 0x01,     0x20,       P_64,        0)
insn(SMSW, 1,                   OpCls( M16,     NONE,     NONE ), F_0FNO66,0,  no_WDS, 0x01,     0x20,       P_286,       0)
ins (STR,  str,  3,             OpCls( RGT8,    NONE,     NONE ), F_0F,    0,  no_WDS, 0x00,     0x08,       P_64,        0)
insn(STR,  1,                   OpCls( M16,     NONE,     NONE ), F_0FNO66,0,  no_WDS, 0x00,     0x08,       P_286,       0)
#endif
/* v2.06: POP/PUSH added */
ins (POP, pop, 3,               OpCls( R16_R64, NONE,     NONE ), 0,       0,  R_in_OP,0x58,     0x00,       P_86,        0)
...
ins (PUSH, push, 4,             OpCls( R16_R64, NONE,     NONE ), 0,       0,  R_in_OP,0x50,     0x00,       P_86,        0)
