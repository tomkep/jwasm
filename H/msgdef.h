...
pick( DISPLACEMENT_OUT_OF_RANGE,   "Displacement out of range: 0x%" I64X_SPEC )
...
pick( NOTE_INCLUDED_BY,            "%*s%s(%" FU32 "): Included by" )
pick( NOTE_MACRO_CALLED_FROM,      "%*s%s(%" FU32 ")[%s%s]: Macro called from" )
pick( NOTE_ITERATION_MACRO_CALLED_FROM, "%*s%s(%" FU32 "): iteration %" FU32 ": Macro called from" )
pick( NOTE_MAIN_LINE_CODE,         "%*s%s(%" FU32 "): Main line code" )
pick( EXTENDING_JUMP,              "Extending jump" )
pick( DIRECTIVE_IGNORED,           "Directive ignored: %s" )
pick( POWER_OF_2,                  "number must be a power of 2: %" FU32 )
...
pick( CONSTANT_VALUE_TOO_LARGE,          "Constant value too large: %" I64X_SPEC "h" )
...
pick( CONSTANT_VALUE_TOO_LARGE_EX,       "Constant value too large: %" I64X_SPEC "%016" I64X_SPEC "h" )
